...
INSERT INTO DangKiem (MaDK, MaXe, NgayDK, HanDK, TrangThai, GhiChu) VALUES
  ('DK001', 'XE001', '2025-09-15', '2026-09-15', 'Còn hạn', 'Theo dõi định kỳ tại trung tâm Mỹ Đình'),
  ('DK002', 'XE002', '2025-07-01', '2026-07-01', 'Còn hạn', 'Hồ sơ đầy đủ'),
  ('DK003', 'XE003', '2025-10-10', '2026-10-10', 'Còn hạn', 'Đang chạy hợp đồng tháng 4'),
  ('DK004', 'XE004', '2025-11-20', '2026-11-20', 'Còn hạn', 'Không có lưu ý đặc biệt'),
  ('DK005', 'XE005', '2024-12-10', '2025-12-10', 'Hết hạn', 'Đang bảo trì nên chưa đi đăng kiểm lại'),
  ('DK006', 'XE006', '2025-06-05', '2026-06-05', 'Còn hạn', 'Xe vận hành ổn định'),
  ('DK007', 'XE007', '2025-08-15', '2026-08-15', 'Còn hạn', 'Xe gia đình 7 chỗ'),
  ('DK008', 'XE008', '2025-08-18', '2026-08-18', 'Còn hạn', 'Đăng kiểm đúng lịch'),
  ('DK009', 'XE009', '2025-09-01', '2026-09-01', 'Còn hạn', 'Bảo trì điều hòa sau'),
  ('DK010', 'XE010', '2025-10-01', '2026-10-01', 'Còn hạn', 'Không phát sinh lỗi'),
  ('DK011', 'XE011', '2025-11-05', '2026-11-05', 'Còn hạn', 'Đủ điều kiện cho thuê'),
  ('DK012', 'XE012', '2025-09-25', '2026-09-25', 'Còn hạn', 'Không có lỗi phát sinh'),
  ('DK013', 'XE013', '2025-04-12', '2026-04-25', 'Sắp hết hạn', 'Ưu tiên xử lý cùng đợt bảo trì'),
  ('DK014', 'XE014', '2025-07-28', '2026-07-28', 'Còn hạn', 'Theo dõi đúng hạn'),
  ('DK015', 'XE015', '2025-12-01', '2026-12-01', 'Còn hạn', 'Mới gia hạn cuối năm trước'),
  ('DK016', 'XE016', '2025-08-05', '2026-08-05', 'Còn hạn', 'Xe còn hạn dài'),
  ('DK017', 'XE017', '2025-03-18', '2026-03-18', 'Hết hạn', 'Cần xử lý trước khi mở lịch mới'),
  ('DK018', 'XE018', '2025-04-20', '2026-04-30', 'Sắp hết hạn', 'Xe cao cấp cần ưu tiên lịch kiểm định'),
  ('DK019', 'XE019', '2025-10-30', '2026-10-30', 'Còn hạn', 'Đã hoàn thành kiểm tra khí thải'),
  ('DK020', 'XE020', '2025-06-14', '2026-06-14', 'Còn hạn', 'Lịch đăng kiểm ổn định');
